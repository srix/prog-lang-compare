...
# Add the project root to sys.path so we can import from builder
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), '..')))

from builder.generate_static_pages import slugify as static_slugify
from builder.generate_language_landing import slugify as landing_slugify
